...
public class TrustStore {
   ...
   public static void createFromCmdLine(String path, char[] password) {
    ...
    */
   public static void create(String cert, String path, char[] password) {
    ...
    * @param password the password for accessing the generated truststore
    */
   public static void create(List<String> certs, String path, char[] password) {
      try {
